...
This is a repository that can be used as a starting point for doing the Number To LCD code kata. It is based on Ruby Quiz #14 (http://rubyquiz.com/quiz14.html).
